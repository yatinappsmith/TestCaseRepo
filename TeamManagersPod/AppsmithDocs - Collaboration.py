...
if __name__ == "__main__":
    test_case = TestCase()
    df = pd.read_csv ('AppsmithDocs - Collaboration.csv')
    #loop through each line in the csv file
    for index, row in df.iterrows():
        test_case = TestCase()
        test_case.set_test_case_title(row['Usecases for collaboration Page'])
        test_case.add_test_case_steps(row['Usecases for collaboration Page'])
        ...
        test_case.add_test_case_labels("Realtime Commenting")
