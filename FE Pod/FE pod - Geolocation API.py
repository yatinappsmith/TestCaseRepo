...
if __name__ == "__main__":
    print("complete")
    test_case = TestCase()
    df = pd.read_csv ('FE pod - Geolocation API.csv')
    #loop through each line in the csv file
    for index, row in df.iterrows():
        test_case = TestCase()
        test_case.set_test_case_title(row['Description'] + " - " + row['Type of test case'])
        ...
        test_case.add_test_case_labels("Geo Location")
